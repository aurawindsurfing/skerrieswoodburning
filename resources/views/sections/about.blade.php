            ...
            <ul class="md:grid md:grid-cols-2 md:col-gap-8 md:row-gap-10">
                ...
                <li class="mt-10 md:mt-0">
                    <div class="flex">
                        ...
                        <div class="ml-4">
                            <h5 class="text-lg leading-6 font-medium text-gray-900">Premium service to all of our
                                clients</h5>
                            <p class="mt-2 text-base leading-6 text-gray-500">
                                We offer a complete service, from providing an initial Training Needs Analysis through
                                to Professional Course Delivery and post delivery Course Feedback.
                            </p>
                        </div>
                    </div>
                </li>
                <li class="mt-10 md:mt-0">
                    <div class="flex">
                        ...
                        <div class="ml-4">
                            <h5 class="text-lg leading-6 font-medium text-gray-900">Understanding our clients needs</h5>
                            <p class="mt-2 text-base leading-6 text-gray-500">
                                From our first contact with a client we focus on understanding our client’s training
                                needs and dedicate ourselves totally to serving those needs.
                            </p>
                        </div>
                    </div>
                </li>
